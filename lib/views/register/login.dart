                ...
                child: Column(
                  ...
                  children: [
                    const Padding(
                      ...
                      child: Center(child: Text("E-IDAMAN",
                      style: TextStyle(
                    ...
                    Padding(
                      ...
                      child: TextFormField(
                        onChanged: (value) {
                          // authenticationCubit.setEmail(emailAddress: value);
                    ...
                    Container(
                      ...
                      child: OutlinedButton(
                        onPressed: () async {
                          if(await authenticationCubit.handleGoogleSignIn()) {
                            print("google singin true");
                            Navigator.pushAndRemoveUntil(context,
                                MaterialPageRoute(
                                    builder: (context) => const HomePage()),
                                    (route) => false);
                          } else {
                            print("============================>google singin ${state.isLoginSuccess}");
                            authenticationCubit.showToast(message: "login failed");
                          }
                        },
                        child: Row(
